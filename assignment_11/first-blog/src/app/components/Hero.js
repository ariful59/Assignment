const Hero = () => {
    return (
            <div className=" hero min-h-screen bg-base-600 bg-gradient-to-r from-cyan-100 to-blue-100">
                <div className="hero-content flex-col lg:flex-row-reverse">
                    <img src="/images/background.jpg" className="max-w-sm h-64 w-256 rounded-lg shadow-xl" />
                    <div>
