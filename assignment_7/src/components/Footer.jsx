const Footer = () => {
    return (
        <div>
            <div className="text-center bg-gray-400 mt-10 mb-10 pb-5 pt-5">
                <h1 className="font-extrabold text-3xl">My Favorite Quota
                </h1>
                <h5 className="mt-5 text-blue-900">Get busy living or get busy dying</h5>
            </div>
